...
enum _Anonymous_0
{
    SD_BUS_CREDS_PID = 1UL << 0,
    SD_BUS_CREDS_TID = 1UL << 1,
    SD_BUS_CREDS_PPID = 1UL << 2,
    SD_BUS_CREDS_UID = 1UL << 3,
    SD_BUS_CREDS_EUID = 1UL << 4,
    SD_BUS_CREDS_SUID = 1UL << 5,
    SD_BUS_CREDS_FSUID = 1UL << 6,
    SD_BUS_CREDS_GID = 1UL << 7,
    SD_BUS_CREDS_EGID = 1UL << 8,
    SD_BUS_CREDS_SGID = 1UL << 9,
    SD_BUS_CREDS_FSGID = 1UL << 10,
    SD_BUS_CREDS_SUPPLEMENTARY_GIDS = 1UL << 11,
    SD_BUS_CREDS_COMM = 1UL << 12,
    SD_BUS_CREDS_TID_COMM = 1UL << 13,
    SD_BUS_CREDS_EXE = 1UL << 14,
    SD_BUS_CREDS_CMDLINE = 1UL << 15,
    SD_BUS_CREDS_CGROUP = 1UL << 16,
    SD_BUS_CREDS_UNIT = 1UL << 17,
    SD_BUS_CREDS_SLICE = 1UL << 18,
    SD_BUS_CREDS_USER_UNIT = 1UL << 19,
    SD_BUS_CREDS_USER_SLICE = 1UL << 20,
    SD_BUS_CREDS_SESSION = 1UL << 21,
    SD_BUS_CREDS_OWNER_UID = 1UL << 22,
    SD_BUS_CREDS_EFFECTIVE_CAPS = 1UL << 23,
    SD_BUS_CREDS_PERMITTED_CAPS = 1UL << 24,
    SD_BUS_CREDS_INHERITABLE_CAPS = 1UL << 25,
    SD_BUS_CREDS_BOUNDING_CAPS = 1UL << 26,
    SD_BUS_CREDS_SELINUX_CONTEXT = 1UL << 27,
    SD_BUS_CREDS_AUDIT_SESSION_ID = 1UL << 28,
    SD_BUS_CREDS_AUDIT_LOGIN_UID = 1UL << 29,
    SD_BUS_CREDS_TTY = 1UL << 30,
    SD_BUS_CREDS_UNIQUE_NAME = 1UL << 31,
    SD_BUS_CREDS_WELL_KNOWN_NAMES = 1UL << 32,
    SD_BUS_CREDS_DESCRIPTION = 1UL << 33,
    SD_BUS_CREDS_AUGMENT = 1UL << 63,
    _SD_BUS_CREDS_ALL = (1UL << 34) - 1
}
...
enum _Anonymous_1
{
    SD_BUS_NAME_REPLACE_EXISTING = 1UL << 0,
    SD_BUS_NAME_ALLOW_REPLACEMENT = 1UL << 1,
    SD_BUS_NAME_QUEUE = 1UL << 2
}
...
enum _Anonymous_2
{
    SD_BUS_MESSAGE_DUMP_WITH_HEADER = 1UL << 0,
    SD_BUS_MESSAGE_DUMP_SUBTREE_ONLY = 1UL << 1
}
...
int sd_bus_message_new_method_call(sd_bus* bus, sd_bus_message** m,
        const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member);
