...
alias sd_bus_message_handler_t = int function (sd_bus_message* m, void* userdata, sd_bus_error* ret_error);
alias sd_bus_property_get_t = int function (sd_bus* bus, const(char)* path, const(char)* interface_, const(char)* property, sd_bus_message* reply, void* userdata, sd_bus_error* ret_error);
alias sd_bus_property_set_t = int function (sd_bus* bus, const(char)* path, const(char)* interface_, const(char)* property, sd_bus_message* value, void* userdata, sd_bus_error* ret_error);
alias sd_bus_object_find_t = int function (sd_bus* bus, const(char)* path, const(char)* interface_, void* userdata, void** ret_found, sd_bus_error* ret_error);
alias sd_bus_node_enumerator_t = int function (sd_bus* bus, const(char)* prefix, void* userdata, char*** ret_nodes, sd_bus_error* ret_error);
...
int sd_bus_call (sd_bus* bus, sd_bus_message* m, ulong usec, sd_bus_error* ret_error, sd_bus_message** reply);
int sd_bus_call_async (sd_bus* bus, sd_bus_slot** slot, sd_bus_message* m, sd_bus_message_handler_t callback, void* userdata, ulong usec);
...
int sd_bus_add_object_vtable (sd_bus* bus, sd_bus_slot** slot, const(char)* path, const(char)* interface_, const(sd_bus_vtable)* vtable, void* userdata);
int sd_bus_add_fallback_vtable (sd_bus* bus, sd_bus_slot** slot, const(char)* prefix, const(char)* interface_, const(sd_bus_vtable)* vtable, sd_bus_object_find_t find, void* userdata);
...
int sd_bus_message_new_signal (sd_bus* bus, sd_bus_message** m, const(char)* path, const(char)* interface_, const(char)* member);
int sd_bus_message_new_method_call (sd_bus* bus, sd_bus_message** m, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member);
...
int sd_bus_message_append_array_memfd (sd_bus_message* m, char type, int memfd, ulong offset, ulong size);
...
int sd_bus_request_name_async (sd_bus* bus, sd_bus_slot** ret_slot, const(char)* name, ulong flags, sd_bus_message_handler_t callback, void* userdata);
...
int sd_bus_call_methodv (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, sd_bus_message** reply, const(char)* types, va_list ap);
int sd_bus_call_method (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, sd_bus_message** reply, const(char)* types, ...);
int sd_bus_call_method_asyncv (sd_bus* bus, sd_bus_slot** slot, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_message_handler_t callback, void* userdata, const(char)* types, va_list ap);
int sd_bus_call_method_async (sd_bus* bus, sd_bus_slot** slot, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_message_handler_t callback, void* userdata, const(char)* types, ...);
int sd_bus_get_property (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, sd_bus_message** reply, const(char)* type);
int sd_bus_get_property_trivial (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, char type, void* ret_ptr);
int sd_bus_get_property_string (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, char** ret);
int sd_bus_get_property_strv (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, char*** ret);
int sd_bus_set_propertyv (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, const(char)* type, va_list ap);
int sd_bus_set_property (sd_bus* bus, const(char)* destination, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_error* ret_error, const(char)* type, ...);
...
int sd_bus_emit_signalv (sd_bus* bus, const(char)* path, const(char)* interface_, const(char)* member, const(char)* types, va_list ap);
int sd_bus_emit_signal (sd_bus* bus, const(char)* path, const(char)* interface_, const(char)* member, const(char)* types, ...);

int sd_bus_emit_properties_changed_strv (sd_bus* bus, const(char)* path, const(char)* interface_, char** names);
int sd_bus_emit_properties_changed (sd_bus* bus, const(char)* path, const(char)* interface_, const(char)* name, ...);
...
int sd_bus_match_signal (sd_bus* bus, sd_bus_slot** ret, const(char)* sender, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_message_handler_t callback, void* userdata);
int sd_bus_match_signal_async (sd_bus* bus, sd_bus_slot** ret, const(char)* sender, const(char)* path, const(char)* interface_, const(char)* member, sd_bus_message_handler_t match_callback, sd_bus_message_handler_t add_callback, void* userdata);
